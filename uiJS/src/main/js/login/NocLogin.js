 ...
 * away by the build system; see `staticHasFeatures` in login.profile.js for more information.
 *
...
define([ 'dojo/has', 'require' ], function (has, require) {
    ...
    /**
     * This LoginMain.js file conditionally executes different code depending upon the host environment it is loaded in.
