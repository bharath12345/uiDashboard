define(["dojo/_base/declare", "dojo/i18n", "dojo/i18n!dashboard/nls/dashboard", "dashboard/logger/Logger", "dojo/dom-construct",
    "dashboard/views/topology/TopologyForm"],

    function (declare, i18n, i18nString, Logger, domConstruct, TopologyForm) {
        ...
        var LayerOne = declare(dashboard.classnames.LayerOne, TopologyForm, {
            ...
            launch: function() {
                ...
                var graphDiv = domConstruct.create('div', {'id':LayerOne.FORMNAME, style:'width: 100%; height: 100%;'});
