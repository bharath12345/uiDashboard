package com.appnomic.appsone.ui.extension.component.action;
...
@Namespace("/component")
public class ComponentUtilityAction extends AbstractAction {
	...
	public String pagesAction() {
        ...
        linkEntityList = LinksListEntity.getDefaultComponentPageEntity().getLinkEntity();
